---
title: "MeCV.ai"
description: 'Platform that evaluates developer proficiency from GitHub activity, analyzing languages and contributions. Built with React, Tailwind, and the GitHub API.'
